...
class UserPromoteCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('email', InputArgument::REQUIRED, 'L\'adresse email de l\'utilisateur auquel on veut rajouter un rôle.')
            ->addArgument('roles', InputArgument::REQUIRED, 'Le rôle que l\'on veut rajouter à l\'utilisateur.')
        ;
    }
